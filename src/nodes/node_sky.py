...
class SkyNode (bpy.types.ShaderNodeCustomGroup):
    """ Node that offers settings for a sky HDR render. It uses the render of the scene as an enviromental texture.
    """
    bl_name = 'Sky HDRI Node'
    bl_label = 'Sky HDRI Node'
